...
import time_dateRange from './dateRange';

describe('time_dateRange', () => {
    test('默认情况下返回当前时间范围', () => {
        const [start, end] = time_dateRange();
        const now = new Date();
