...
import array_durstenfeldShuffle from './durstenfeldShuffle.js';

describe('array_durstenfeldShuffle Durstenfeld shuffle algorithm', () => {
    let original_arr;
    ...
    it('should return a new array', () => {
        const shuffled = array_durstenfeldShuffle(original_arr);
    ...
    it('should handle empty arrays', () => {
        expect(array_durstenfeldShuffle([])).toEqual([]);
    });

    it('should handle arrays with one element', () => {
        expect(array_durstenfeldShuffle([1])).toEqual([1]);
    });
    ...
    it('should not modify the original array', () => {
        array_durstenfeldShuffle(original_arr);
        expect(original_arr).toEqual([1, 2, 3, 4, 5]);
    });

    it('should handle arrays with duplicate elements', () => {
        const duplicateArray = [1, 2, 2, 3, 3, 3];
        const shuffled = array_durstenfeldShuffle(duplicateArray);
