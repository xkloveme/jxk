...
import array_uniqueByField from './uniqueByField.js';

describe('array_uniqueByField', () => {
    it('returns unique array by age', () => {
        ...
        const result = array_uniqueByField(array, 'age');
    ...
    it('returns unique array by class', () => {
        ...
        const result = array_uniqueByField(array, 'class');
        expect(result).toEqual([
            { age: 20, name: 'Andy', class: 'English' },
            { age: 21, name: 'Jack', class: 'History' },
            { age: 20, name: 'Jenson', class: 'Physics' },
